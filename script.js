...
function agregarError(mensaje, camposConError = []) {
...
formulario.addEventListener("submit", (evento) => {
    ...
    if (valores.nombre && !patronNombre.test(valores.nombre)) {
        agregarError(
    ...
    if (valores.apellido && !patronNombre.test(valores.apellido)) {
        agregarError(
    ...
    if (
        ...
        agregarError(
            ...
            [campos.ciudad, campos.estado, campos.codigoPostal, campos.pais]
        );
        hayErrores = true;
    }
